...
*/
class CacheResourceCustomPDOGzipTests extends PHPUnit_Framework_TestCase
{
    public function setUp()
    {
        ...
        $this->smarty->registerCacheResource('pdo', new Smarty_CacheResource_Pdo_Gzip($cnx, 'smarty_cache')); 
    }
